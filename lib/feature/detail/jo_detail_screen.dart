                        ...
                        child: Obx(() => Column(
                              children: [
                                controller.labs.value.isNotEmpty ? ListView.builder(
                                    itemCount: controller.labs.value.toSet().toList().length,
                                    itemBuilder: (context,index){
                                      var lab = controller.labs.value.toSet().toList();
                                      return Column(
                                        children: [
                                          SizedBox(
                                            child: InkWell(
                                              onTap: (){
                                                controller.detailLabActivity(lab[index]);
                                              },
                                              child: Card(
                                                  color: Colors.white,
                                                  child: Padding(
