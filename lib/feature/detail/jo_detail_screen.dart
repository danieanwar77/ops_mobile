      ...
      builder: (controller) => controller.isLoadingJO == false
          ? DefaultTabController(
              ...
              child: Scaffold(
                  appBar: AppBar(
                    actions: [
                      controller.activity6ListStages.value.isNotEmpty && controller.activityStage == 6
                          ? Padding(
                                        ...
                                        child: Padding(
                                            ...
                                            child: Column(children: [
                                              Row(children: [
                                                ...
                                                controller.dataJoDetail.value.detail?.statusJo != 'On Progres'
                                                    ? Container(
                                                                ...
                                                                Column(children: [
                                                                  ...
                                                                  Row(
                                                                    children: [
                                                                      ...
                                                                      Expanded(
                                                                        child: Text(
                                                                          double.parse(progressActivity!.actualQty!).toString() ?? '-',
                                                                          style: const TextStyle(
                                                                            fontSize: 14,
                                                                          ),
                                                                        ),
