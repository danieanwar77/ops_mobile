                                          ...
                                          child: Padding(
                                              ...
                                              child: Column(children: [
                                                ...
                                                controller.activityListStages
                                                                ...
                                                                ? Column(
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        const SizedBox(
                                                                            height:
                                                                                8),
                                                                        for (var progressActivity in controller
                                                                            .activityListStages
                                                                            .value
                                                                            .where((item) =>
                                                                                item.mStatusinspectionstagesId ==
                                                    ...
                                                    : const SizedBox(),
                                                controller.activity5ListStages
                                                        .value.isNotEmpty
                                                    ? Column(
                                                        crossAxisAlignment:
                                                            CrossAxisAlignment
                                                    ...
                                                    : const SizedBox(),
                                                controller.activity6ListStages
                                                        .value.isNotEmpty
                                                    ? Column(
                                                        crossAxisAlignment:
                                                            CrossAxisAlignment
                                                                ...
                                                                ? GridView
                                                                    .builder(
                                                                        ...
                                                                        itemBuilder:
                                                                          ...
                                                                          final File
                                                                              attach =
                                                                              controller.activity6Attachments.value[index];
                                                                          final String
                                                                              fileType =
                                                                              controller.checkFileType(attach.path);
                                                                          var filenameArr = attach
                                                                              .path
                                                                              .split("/");
                                                                          var filename =
                                                                              filenameArr.last;
                                    ...
                                    () => Column(children: [
                                      for (var lab in controller.labs.value)
                                        SizedBox(
                                          child: InkWell(
                                            onTap: () {
                                              controller.detailLabActivity(
                                                  int.parse(lab.laboratoriumId
                                                      .toString()));
                                            },
                                            child: Card(
                                                color: Colors.white,
                                ...
                                child: Padding(
                                  ...
                                  child: Column(children: [
                                    controller.statusId == 4
                                        ...
                                        : const SizedBox(),
                                    const SizedBox(height: 16),
                                    controller.inspectionDocuments.value
                                            .isNotEmpty
                                        ? Card(
                                            color: Colors.white,
                                            child: SizedBox(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(children: [
                                    controller.statusId == 4
                                        ...
                                        : const SizedBox(),
                                    const SizedBox(height: 16),
                                    controller.laboratoryDocuments.value
                                            .isNotEmpty
                                        ? Card(
                                            color: Colors.white,
                                            child: SizedBox(
