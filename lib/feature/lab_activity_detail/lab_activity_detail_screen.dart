                            ...
                            child: Padding(
                                ...
                                child: Column(children: [
                                  Row(children: [
                                    ...
                                    (controller.activityLabStage == 1)
                                        ? Container(
                                            ...
                                            child: Text(controller.stageList.isEmpty ? "None" : controller.labStagesName[(controller.activityLabStage -1)], style: TextStyle(color: Colors.white)))
                                        : const SizedBox(),
                                    Spacer(),
                                    controller.stageList.value.isEmpty
                                        ? IconButton(
                                            onPressed: () {
                                              if (controller.activitySubmitted.value == true) {
                                                controller.activityLabStage == 1
                                                    ? controller.nextStageActivityConfirm()
                                                    : controller.activityLabStage > 1 && controller.activityLabStage < 5
                                                        ? controller.nextStageActivityConfirm()
                                  ...
                                  controller.stageList.value.isNotEmpty
                                      ...
                                      children: [controller.stageList.value.where((item) => item.mStatuslaboratoryprogresId == 1).isNotEmpty
                                              ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                  Row(
                                                    children: [
                                                      Text(
                                                        controller.labStagesName[0],
                                              ...
                                              : const SizedBox(),
                                          controller.activityLabListStages.value.where((item) => item.mStatuslaboratoryprogresId == 2).isNotEmpty
                                              ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                  Row(
                                                    children: [
                                                      const Text(
                                                  ...
                                                  const SizedBox(height: 8),
                                                  for (var progressActivity in controller.activityLabListStages.value.where((item) => item.mStatuslaboratoryprogresId == 2))
                                                    Column(children: [
                                                      Row(
                                                        children: [
                                                          Expanded(
                                              ...
                                              : const SizedBox(),
                                          controller.activityLabListStages.value.where((item) => item.mStatuslaboratoryprogresId == 3).isNotEmpty
                                              ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                  Row(
                                                    children: [
                                                      const Text(
                                                  ...
                                                  const SizedBox(height: 8),
                                                  for (var progressActivity in controller.activityLabListStages.value.where((item) => item.mStatuslaboratoryprogresId == 3))
                                                    Column(children: [
                                                      Row(
                                                        children: [
                                                          Expanded(
                                              ...
                                              : const SizedBox(),
                                          controller.activityLabListStages.value.where((item) => item.mStatuslaboratoryprogresId == 4).isNotEmpty
                                              ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                  Row(
                                                    children: [
                                                      const Text(
                                                  ...
                                                  const SizedBox(height: 8),
                                                  for (var progressActivity in controller.activityLabListStages.value.where((item) => item.mStatuslaboratoryprogresId == 4))
                                                    Column(children: [
                                                      Row(
                                                        children: [
                                                          Expanded(
