...
class Activity5 {
  ...
  Data? _data;
  String? _message;
Activity5 copyWith({  num? httpCode,
  Data? data,
  String? message,
}) => Activity5(  httpCode: httpCode ?? _httpCode,
  data: data ?? _data,
...
Data copyWith({  List<Detail>? detail,
  List<Barge>? barge,
  List<Transhipment>? transhipment,
}) => Data(  detail: detail ?? _detail,
  barge: barge ?? _barge,
...
class Transhipment {
  ...
  String? _jetty;
  String? _name;
Transhipment copyWith({  String? initialDate,
  String? finalDate,
  num? deliveryQty,
  String? jetty,
  String? name,
}) => Transhipment(  initialDate: initialDate ?? _initialDate,
