...
class TDJoFinalizeLaboratoryModel {
  TDJoFinalizeLaboratoryModel({
    num? id,
    num? tHJoId,
    String? noReport,
    String? dateReport,
  ...
  TDJoFinalizeLaboratoryModel.fromJson(dynamic json) {
    _id = json['id'];
  ...
  String? _createdAt;
  String? _updatedAt;
  TDJoFinalizeLaboratoryModel copyWith({  num? id,
    num? tHJoId,
    String? noReport,
    String? dateReport,
    String? noBlankoCertificate,
    ...
    String? createdAt,
    String? updatedAt,
  }) => TDJoFinalizeLaboratoryModel(  id: id ?? _id,
